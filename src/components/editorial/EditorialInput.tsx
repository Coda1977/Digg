  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex w-full border-3 border-ink bg-paper px-5 py-5 text-base text-ink transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-ink placeholder:text-ink-lighter focus-visible:outline-none focus-visible:border-accent-red disabled:cursor-not-allowed disabled:opacity-50",
